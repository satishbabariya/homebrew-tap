...
#
# Generated by the release workflow, which stamps the url and sha256 of the tag
# it built. Do not edit this file by hand: pull the next one from the release
# assets, so the checksum is always the one that was actually built.
#
...
class Sandbox < Formula
  ...
  url "https://github.com/satishbabariya/sandbox/archive/refs/tags/v0.1.3.tar.gz"
  sha256 "116651a4f5f3f36b35dee167efb2921403061f304fc4e26ed1c9e586997074a0"
  license "Apache-2.0"
